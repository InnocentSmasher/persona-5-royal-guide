        ...
        <Layout>
            ...
            <main>
                ...
                <div className="day">
                    ...
                    <h4>Evening</h4>
                    <ul>
                        <li>Fortune Rank 7.1 <strong>(Request "Debunking the Psychic!" unlocked)</strong>
                            <ol>
                                <li>-</li>
                                <li>-</li>
                                <li>-</li>
                ...
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Interact with desk in your room, Repair laptop <strong>(Proficiency +7)</strong> <strong>(Normal
                            Route Proficiency Lv. 5)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Sat 9/3</h3>
                    ...
                    <h4>Evening</h4>
                    <ul>
                        <li>Interact with laptop in your room, Shop Tanaka Net</li>
                        <li>Talk to Akechi in Leblanc, Justice Rank 6
                            <ol>
                                ...
                                <li>(Phone) Choice 3: "My bad, I guess." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Investigate Shibuya arcade <strong>(Request "Winners Don't Use Cheats" unlocked)</strong>
                        </li>
                        <li>Talk to Futaba outside Leblanc, Hermit Rank 2 <strong>(Requires Kindness Lv. 4)</strong>
                            <ol>
                                <li>Choice 2: "That's a great idea." (+2)</li>
                                <li>Choice 1: "If we work together." (+3)</li>
                                <li>Choice 1: "Sounds good to me." (+0)</li>
                                <li>(Phone) Choice 1: "I bet it will." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        ...
                        <li>Jazz club with Emperor <strong>(Learns Charge)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Mon 9/5</h3>
                    ...
                    <ul>
                        <li>Hermit Rank 3
                            <ol>
                                ...
                                <li>(Phone) Choice 3: "We'll both do our best." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Hierophant Rank 5 <strong>(Kindness +3)</strong>
                            <ol>
                                ...
                                <li>(Phone) Choice 2: "She needs a balanced diet." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul>
                        ...
                        <li><strong>Mementos Palace</strong>
                            <ol>
                                ...
                                <li><strong>[Normal Route]</strong> Fighting for Truth of Journalism</li>
                ...
                <div className="day">
                    ...
                    <ul>
                        <li>Money Reading <strong>(Y5000)</strong></li>
                        <li>Luck Reading <strong>(Y5000)</strong> <strong>(Boost Knowledge)</strong></li>
                        <li>Visit Kichijoji info stand, Ask the receptionist every question <strong>(Knowledge
                            +3)</strong></li>
                        <li><strong>Reach treasure in Spaceport Palace</strong></li>
                        <li><strong>Need to obtain Empress and Tower personas</strong></li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Call Kawakami for massage</li>
                        <li>Crossword: "Festival" <strong>(Knowledge +3)</strong></li>
                        <li>Trade Thief Mask for Magic UP Fuda x2</li>
                        <li>Star Rank 6 <strong>(Knowledge +3)</strong>
                            <ol>
                                <li>Choice 2: "Is that frustrating?" (+2)</li>
                                <li>Choice 3: "Do what you love." (+2)</li>
                                <li>(Phone) Choice 2: "You're imagining things." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Affinity Reading <strong>(Y5000)</strong> with matching arcana <strong>(Star +2)</strong>
                        </li>
                    ...
                    <h4>Evening</h4>
                    <ul>
                        <li>Finish reading "Master Swordsman" <strong>(Guts +10)</strong> <strong>(Battle Route Guts Lv.
                            5)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <ul>
                        <li>Call Kawakami for massage</li>
                        <li>Talk to Mishima in Akihabara streets, Moon Rank 6.1</li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Thu 9/22</h3>
                    <h4>Daytime</h4>
                    <ul>
                        <li>Buy "Heroic Revelations" from Jinbocho</li>
                    ...
                    <h4>Evening</h4>
                    <ul>
                        <li>TV Quiz: "Ten years in prison." <strong>(Knowledge +2)</strong> <strong>(Knowledge Lv.
                            5)</strong></li>
                        <li>Hierophant Rank 6 <strong>(Kindness +7)</strong> <strong>(Kindness Lv. 5)</strong>
                            <ol>
                                <li>Choice 3: "To each his own." (+2)</li>
                                <li>Choice 3: "Shut your mouth." (+3)</li>
                                <li>Choice 1: "Saving Futaba was no mistake." (+2)</li>
                                <li>(Phone) Choice 3: "If I can help somehow…" (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <h4>Class</h4>
                    <ul>
                        <li>Read "Heroic Revelations"</li>
                    </ul>
                    <h4>Daytime</h4>
                    <ul>
                        <li>Councillor Rank 6
                            <ol>
                    ...
                    <h4>Evening</h4>
                    <ul>
                        <li><strong>[Normal Route]</strong> Devil Rank 8 <strong>(Charm +5)</strong>
                            <ol>
                                <li>-</li>
                                <li>-</li>
                                <li>-</li>
                                <li>Choice 3: <strong>"I'll go with you"</strong> (+3)</li>
                                <li>(Phone) Choice 1: "Good luck." (+2)</li>
                            </ol>
                        </li>
                        <li><strong>[Battle Route]</strong> Affinity Reading <strong>(Y5000)</strong> with matching
                            arcana <strong>(Devil +2)</strong></li>
                        <li><strong>[Battle Route]</strong> Devil Rank 6
                            <ol>
                                <li>-</li>
                ...
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Buy "Call Me Chief" from Jinbocho</li>
                        <li>Hermit Rank 4
                            <ol>
                                <li>Choice 2: "Let's do this together." (+3)</li>
                                <li>-</li>
                                <li>Choice 3: "I think it's cute." (+3)</li>
                                <li>(Phone) Choice 3: "I'll help you anytime." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Hanged Rank 6
                            <ol>
                                ...
                                <li>(Phone) Choice 1: "He's my age, so it comes easier." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Priestess Rank 9 Friendship
                            <ol>
                                ...
                                <li>(Phone) Choice 1: "No problem at all." (+2)</li>
                            </ol>
                        </li>
                        <li>Priestess Rank 9 Romance
                            <ol>
                                <li>Choice 2: "Your fight's with me." (+3)</li>
                                <li>Choice 1: "We should get out of here." (+2)</li>
                                <li>Choice 2: "That was the right move." (+2)</li>
                                ...
                                <li>(Phone) Choice 1: "I'd do anything for you." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Jazz club with Priestess <strong>(Learns Concentrate)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Mon 9/26</h3>
                    <h4>Daytime</h4>
                    <ul>
                        <li>Tower Rank 2 <strong>(Kindness +5)</strong>
                            <ol>
                                ...
                                <li>(Phone) Choice 1: "I'll work hard." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Rain</li>
                        <li>Star Rank 7 <strong>(Knowledge +2)</strong>
                            <ol>
                ...
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Interact with crane game in Akihabara arcade
                            <ol>
                                <li>Receive Jack Frost Doll</li>
                            </ol>
                        </li>
                        <li>Death Rank 8 <strong>(Guts +2)</strong>
                            <ol>
                                <li>-</li>
                                <li>Choice 2: "Let's get to work, doctor." (+3)</li>
                                <li>Choice 1: <strong>"It's for Miwa-chan."</strong> (+3)</li>
                                <li>(Phone) Choice 1: "I'll be cheering you on." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Fortune Rank 8
                            <ol>
                                ...
                                <li>(Phone) Choice 2: "It was all your own will." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <ul>
                        <li>Hermit Rank 5
                            <ol>
                                ...
                                <li>(Phone) Choice 1: "You did great." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        ...
                        <li>Star Rank 7.1 <strong>(Requires Knowledge Lv. 5)</strong> <strong>(Request "Upstaging the
                            Stage Mother" unlocked)</strong>
                            <ol>
                                <li>-</li>
                ...
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Tower Rank 3 <strong>(Kindness +3)</strong>
                            <ol>
                                <li>-</li>
                                <li>-</li>
                                <li>-</li>
                                <li>Choice 1: "That's the spirit." (+2)</li>
                                <li>(Phone) Choice 1: "Sure." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        ...
                        <li>Fortune Rank 9 Friendship
                            <ol>
                                <li>-</li>
                                <li>Choice 2: "Well, fate can be changed." (+3)</li>
                                <li>Choice 1: "I like having my fortune read." (+0)</li>
                                <li>(Phone) Choice 1: "I'm planning on it." (+2)</li>
                            </ol>
                        </li>
                        <li>Fortune Rank 9 Romance
                            <ol>
                                <li>-</li>
                                <li>Choice 2: "Well, fate can be changed." (+3)</li>
                                <li>Choice 2: "So I can be with you." (+0)</li>
                                <li>(Phone) Choice 1: "I wanted to hear your voice too." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Buy "The Art of Automata" from Jinbocho</li>
                        <li>Councillor Rank 7
                            <ol>
                    ...
                    <h4>Evening</h4>
                    <ul>
                        <li><strong>[Normal Route]</strong> Devil Rank 9 Friendship
                            <ol>
                                <li>-</li>
                        ...
                        <li><strong>[Normal Route]</strong> Devil Rank 9 Romance
                            <ol>
                                <li>-</li>
                                <li>Choice 2: "You're not giving up, are you?" (+2)</li>
                                <li>Choice 1: <strong>"I can't leave you."</strong> (+3)</li>
                                ...
                                <li>(Phone) Choice 1: "I wanted to hear your voice." (+2)</li>
                            </ol>
                        </li>
                        <li><strong>[Battle Route]</strong> Devil Rank 7 <strong>(Charm +5)</strong>
                            <ol>
                                <li>-</li>
                ...
                <div>
                    <Link to="../october">Go to October</Link>
                </div>
            </main>
        </Layout>
    );
