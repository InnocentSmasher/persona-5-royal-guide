        ...
        <Layout>
            ...
            <main>
                ...
                <div className="day">
                    ...
                    <h4>Train</h4>
                    <ul>
                        <li>Finish reading "ABCs of Crafting" <strong>(Doubles the number of items that can be
                            crafted)</strong></li>
                    </ul>
                    <h4>Class</h4>
                    <ul>
                    ...
                    <ul>
                        ...
                        <li>Buy Mammoth Summer lottery ticket <strong>(Y5000)</strong> from Shibuya <strong>(Does not
                            unlock "Easy Money", only weekly or daily prizes do)</strong></li>
                        <li>Lovers Rank 8
                            <ol>
                                ...
                                <li>(Phone) Choice 3: "You can ask her yourself." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        ...
                        <li>Temperance Rank 8 <strong>(Y5000)</strong>
                            <ol>
                                ...
                                <li>(Phone) Choice 3: "I'll do anything for you." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Temperance Rank 8.1 <strong>(Auto)</strong> <strong>(Request "A Teacher Maid to Suffer"
                            unlocked)</strong>
                            <ol>
                                <li>-</li>
                                <li>-</li>
                    ...
                    <ul>
                        ...
                        <li>Priestess Rank 4
                            <ol>
                                ...
                                <li>Choice 3: "It's an amazing goal." (+3)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Justice Rank 3 <strong>(Requires Charm Lv. 3 and Knowledge Lv. 3)</strong>
                            <ol>
                                <li>-</li>
                                ...
                                <li>-</li>
                                <li>-</li>
                                <li>(Phone) Choice 2: "Wasn't it fun?" (+2)</li>
                            </ol>
                        </li>
                ...
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Chariot Hangout Ichigaya <strong>(Ichigaya unlocked)</strong>
                            <ol>
                ...
                <div className="day">
                    ...
                    <h4>Train</h4>
                    <ul>
                        <li>Finish reading "The Illusory Popess" <strong>(Kindness +5)</strong></li>
                    </ul>
                    <h4>Class</h4>
                    <ul>
                    ...
                    <ul>
                        <li>Rain</li>
                        <li>Borrow "The Great Thief" from library</li>
                        <li>Emperor Rank 2
                            <ol>
                                <li>Choice 2: "It's enigmatic." (+2)</li>
                                <li>Choice 1: "I can't wait." (+3)</li>
                                <li>(Phone) Choice 1: "You're already doing enough." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                ...
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li><strong>Mementos Palace</strong>
                            <ol>
                                <li>The Bark and Bite of a Bully</li>
                                <li>An Elderly's Meaning of Life</li>
                                <li>If Cats Disappeared from the City</li>
                                <li>Sadism Is Just a Sign of Love</li>
                                <li>Phantom Thieves VS Burglary Ring</li>
                                <li>Ending the Boyfriend's Abuse</li>
                                <li>A Teacher Maid to Suffer</li>
                            </ol>
                        </li>
                        <li><strong>Need to obtain Fortune persona</strong></li>
                        <li><strong>Money should stop being an issue</strong></li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                ...
                <div className="day">
                    ...
                    <h4>Class</h4>
                    <ul>
                        <li>Finish reading "The Great Thief" <strong>(Knowledge +5)</strong> <strong>(Normal Route
                            Knowledge Lv. 4)</strong></li>
                    </ul>
                    <h4>All Day</h4>
                    <ul>
                        <li>Rain</li>
                    ...
                    <ul>
                        <li>Chariot Rank 9
                            <ol>
                                ...
                                <li>(Phone) Choice 1: "Congratulations." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Temperance Rank 9 Friendship <strong>(Y5000)</strong>
                            <ol>
                                <li>Choice 1: "Nonsense." (+3)</li>
                                <li>Choice 1: "What a bummer." (+3)</li>
                                <li>Choice 2: "I want to keep seeing you." (+2)</li>
                                <li>Choice 2: "Got it ." (+2)</li>
                                <li>(Phone) Choice 2: "You can do it." (+2)</li>
                            </ol>
                        </li>
                        <li>Temperance Rank 9 Romance <strong>(Y5000)</strong>
                            <ol>
                                <li>Choice 1: "Nonsense." (+3)</li>
                                <li>Choice 1: "What a bummer." (+3)</li>
                                <li>Choice 2: "I want to keep seeing you." (+2)</li>
                ...
                <div className="day">
                    ...
                    <h4>Class</h4>
                    <ul>
                        <li>Question with matching arcana: "The Milky Way." and "Soumen noodles." <strong>(Charm
                            +2)</strong> <strong>(Lovers +2)</strong></li>
                        <li>Temperance Rank 9.1 <strong>(Auto)</strong></li>
                    </ul>
                    <h4>Daytime</h4>
                    <ul>
                        <li>Borrow "The Running Dead" from DVD store</li>
                        <li>Buy "Ghost Encounters" from Shibuya bookstore</li>
                        <li>Faith Rank 4
                            <ol>
                ...
                <div className="day">
                    ...
                    <h4>Train</h4>
                    <ul>
                        <li>Finish reading "Ghost Encouters" <strong>(Guts +5)</strong></li>
                    </ul>
                    <h4>Daytime</h4>
                    <ul>
                        <li>Buy Soothing Soba from Shibuya convenience store</li>
                        <li>Lovers Rank 9 Friendship
                            <ol>
                                <li>-</li>
                                <li>-</li>
                        ...
                        <li>Lovers Rank 9 Romance
                            <ol>
                                ...
                                <li>-</li>
                                <li>(Phone) Choice 2: "I'm yours forever." (+3)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Ask Chihaya for a Luck Reading <strong>(Y5000)</strong> <strong>(Boost Kindness)</strong>
                        </li>
                ...
                <div className="day">
                    ...
                    <h4>Class</h4>
                    <ul>
                        <li>Question: "A triangle." <strong>(Knowledge +2)</strong> <strong>(Battle Route Knowledge Lv.
                            4)</strong></li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Talk to Hifumi in Kanda church, Star Rank 1 <strong>(Requires Charm Lv. 3)</strong> <strong>(Knowledge
                            +2)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Save for chalk dodge reload</li>
                        <li>Watch "The Running Dead" <strong>(Guts +5)</strong> <strong>(Normal Route Guts Lv.
                            4)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <h4>Class</h4>
                    <ul>
                        <li>Question: "Memories that last a long time.", "Infinite.", and "Forever." <strong>(Knowledge
                            +2)</strong></li>
                        <li>Reload chalk dodge for <strong>(Charm +3)</strong></li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Trade Soothing Soba for Koedo Sword</li>
                        <li>Talk to Mishima in Shinjuku streets, Moon Rank 3</li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Tue 7/12</h3>
                    ...
                    <ul>
                        ...
                        <li>Fortune Rank 2
                            <ol>
                                ...
                                <li>(Phone) Choice 1: "Of course I am." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <h4>All Day</h4>
                    <ul>
                        <li>Exams: "64 degrees.", "Zhuge Liang.", "Barbarians' heads.", and "To offer them instead of
                            heads."
                        </li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <h4>All Day</h4>
                    <ul>
                        <li>Exams: "Red King Crab, <strong>(Paralithodes)</strong>." and "It caused confusion in the
                            economy."
                        </li>
                    </ul>
                </div>
                ...
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Sun Rank 8 <strong>(Charm +7)</strong> <strong>(Charm Lv. 4)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Mon 7/18</h3>
                    ...
                    <ul>
                        <li>Cannot leave Leblanc</li>
                        <li>Finish watching "The Running Dead" <strong>(Guts +5)</strong> <strong>(Battle Route Guts Lv.
                            4)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Borrow "Jail Break" from DVD store</li>
                        <li>Priestess Rank 5
                            <ol>
                                <li>Choice 3: "He sounds suspicious." (+3)</li>
                                <li>Choice 1: "I got this." (+3)</li>
                                <li>(Phone) Choice 3: "Try to reach out to her." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        ...
                        <li>Talk to Sojiro for exam reward - Dandy Mirror - Counterstrike</li>
                        <li>Fortune Rank 3
                            <ol>
                ...
                <div className="day">
                    ...
                    <ul>
                        <li>Cannot leave Leblanc</li>
                        <li>Play "Star Forneus" <strong>(Guts +3)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Fri 7/22</h3>
                    ...
                    <ul>
                        <li>Cannot leave Leblanc</li>
                        <li>Watch "Jail Break" <strong>(Proficiency +5)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Sat 7/23</h3>
                    ...
                    <ul>
                        <li>Cannot leave Leblanc</li>
                        <li>Finish watching "Jail Break" <strong>(Proficiency +5)</strong> <strong>(Battle Route
                            Proficiency Lv. 4)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Sun 7/24</h3>
                ...
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Ask Chihaya for a Money Reading <strong>(Y5000)</strong></li>
                        <li><strong>Reach treasure in Pyramid Palace</strong></li>
                        <li><strong>Need to obtain Hermit, Hanged, Devil, and Star personas</strong></li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                ...
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Star Rank 2 <strong>(Knowledge +2)</strong>
                            <ol>
                                <li>Choice 1: "That's interesting." (+2)</li>
                                <li>-</li>
                                <li>Choice 3: "But you don't want to, right?" (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul>
                        <li>Emperor Rank 4
                            <ol>
                                ...
                                <li>(Phone) Choice 1: "Don't get discouraged." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Fortune Rank 4
                            <ol>
                                ...
                                <li>-</li>
                                <li>-</li>
                                <li>(Phone) Choice 2: "I didn't do much." (+2)</li>
                            </ol>
                        </li>
                ...
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Justice Hangout Shinagawa <strong>(Shinagawa unlocked)</strong> <strong>(Devil +3)</strong>
                            <ol>
                                <li>Choice 1: "It's a nice place." (+3)</li>
                                <li>-</li>
                                <li>Choice 1: "If you like." (Devil +2)</li>
                                <li>Choice 2: "It's nothing bad." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                ...
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Keep sitting on sofa in front furniture store in east Kichijoji <strong>(Guts +3)</strong>
                        </li>
                        <li>Watch movies in Shinjuku <strong>(Guts +10)</strong></li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Visit the donut shop across from the Kichijoji power stone shop, Answer Morgana's
                            quiz <strong>(Guts +3)</strong></li>
                        <li>Fortune Rank 5
                            <ol>
                ...
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Ask Chihaya for Affinity Reading <strong>(Y5000)</strong> with matching arcana <strong>(Chariot
                            +2)</strong></li>
                        <li>Luck Reading <strong>(Y5000)</strong> <strong>(Boost Charm)</strong></li>
                        <li>Aojiru <strong>(Y5000)</strong> <strong>(Charm +3)</strong></li>
                        <li>Watch movies in Shibuya <strong>(Charm +10)</strong></li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Sun Rank 9</li>
                ...
                <div>
                    <Link to="../august">Go to August</Link>
                </div>
            </main>
        </Layout>
    );
