        ...
        <Layout>
            ...
            <main>
                ...
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Buy "Game Secrets" and "Pro Darts" from Shinjuku bookstore</li>
                ...
                <div className="day">
                    ...
                    <h4>Train</h4>
                    <ul>
                        <li>Finish reading "Game Secrets" <strong>(Retro game cheats unlocked)</strong></li>
                    </ul>
                    <h4>Class</h4>
                    <ul>
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Borrow "Woman in the Dark" from library</li>
                        <li>Talk to Haru at Shujin rooftop, Empress Rank 1</li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Justice Rank 7 <strong>(Requires Knowledge Lv. 4)</strong>
                            <ol>
                                ...
                                <li>(Phone) Choice 3: "We're rivals, aren't we?" (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul>
                        <li>Empress Rank 2
                            <ol>
                                ...
                                <li>(Phone) Choice 3: "Jewel Melon." (+3)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li><strong>[Normal Route]</strong> Moon Rank 10</li>
                        <li><strong>[Battle Route]</strong> Moon Rank 9</li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Fri 11/4</h3>
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Tower Rank 9 <strong>(Kindness +5)</strong>
                            <ol>
                                ...
                                <li>(Phone) Choice 3: "You did a great job too." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        ...
                        <li><strong>[Battle Route]</strong> Devil Rank 8 <strong>(Charm +5)</strong>
                            <ol>
                                <li>-</li>
                                <li>-</li>
                                <li>-</li>
                ...
                <div className="day">
                    ...
                    <h4>Train</h4>
                    <ul>
                        <li>Finish reading "Pro Darts" <strong>(Darts smaller circle unlocked)</strong></li>
                    </ul>
                    <h4>Class</h4>
                    <ul>
                        <li>Finish reading "Woman in the Dark" <strong>(Proficiency +5)</strong></li>
                    </ul>
                    <h4>Daytime</h4>
                    <ul>
                        <li>Borrow "Dressed in Ashes" from library</li>
                        <li>Empress Rank 3
                            <ol>
                                <li>Choice 3: "It'll be okay, I promise." (+3)</li>
                                <li>Choice 1: "I don't want to go with you." (+3)</li>
                                <li>Choice 2: "Not yet." (+3)</li>
                                <li>(Phone) Choice 1: "Smart response." (+3)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Talk to Akechi to initiate solo battle, Justice Rank 8
                            <ol>
                                <li>-</li>
                                <li>-</li>
                                <li>-</li>
                ...
                <div className="day">
                    ...
                    <ul>
                        <li><strong>[Normal Route]</strong> Free Time</li>
                        <li><strong>[Battle Route]</strong> Empress Hangout Asakusa
                            <ol>
                    ...
                    <h4>Evening</h4>
                    <ul>
                        <li>Hanged Rank 8 <strong>(Proficiency +5)</strong>
                            <ol>
                ...
                <div className="day">
                    ...
                    <ul>
                        <li>Crane game
                            <ol>
                                <li>Receive Wanna-kun Doll</li>
                            </ol>
                        </li>
                        <li>Empress Rank 4 <strong>(Requires Proficiency Lv. 5)</strong>
                            <ol>
                                ...
                                <li>(Phone) Choice 3: "Let's get coffee again sometime." (+3)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Star Rank 8 <strong>(Knowledge +2)</strong>
                            <ol>
                                <li>Choice 3: "I'm glad her heart changed." (+3)</li>
                                <li>-</li>
                                <li>(Phone) Choice 1: "I support it." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul>
                        ...
                        <li>Empress Rank 5
                            <ol>
                                ...
                                <li>(Phone) Choice 3: "Pinch yourself." (+3)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Hanged Rank 9
                            <ol>
                                ...
                                <li>(Phone) Choice 1: "Like father, like son." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul>
                        ...
                        <li>Hermit Rank 8
                            <ol>
                                ...
                                <li>-</li>
                                <li>(Phone) Choice 3: "Want more pats?" (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Star Hangout Jinbocho <strong>(If Star Rank 9 available, Free Time)</strong>
                            <ol>
                ...
                <div className="day">
                    ...
                    <h4>Train</h4>
                    <ul>
                        <li>Finish reading "Dressed in Ashes" <strong>(Charm +5)</strong></li>
                    </ul>
                    <h4>Class</h4>
                    <ul>
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Borrow "The Hero with a Bow" from library</li>
                    ...
                    <ul>
                        ...
                        <li><strong>[Normal Route]</strong> Free Time</li>
                        <li><strong>[Battle Route]</strong> Devil Rank 9 Friendship
                            <ol>
                                <li>-</li>
                        ...
                        <li><strong>[Battle Route]</strong> Devil Rank 9 Romance
                            <ol>
                                <li>-</li>
                                <li>Choice 2: "You're not giving up, are you?" (+2)</li>
                                <li>Choice 1: <strong>"I can't leave you."</strong> (+3)</li>
                ...
                <div className="day">
                    ...
                    <h4>Class</h4>
                    <ul>
                        <li>Finish reading "The Hero with a Bow" <strong>(Guts +5)</strong></li>
                    </ul>
                    <h4>Daytime</h4>
                    <ul>
                        ...
                        <li>Empress Rank 6
                            <ol>
                                ...
                                <li>(Phone) Choice 1: "You can talk to me anytime." (+3)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li><strong>[Normal Route]</strong> Free Time</li>
                        <li><strong>[Battle Route]</strong> Moon Rank 10</li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Sat 11/12</h3>
                ...
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Hermit Rank 9 Friendship
                            <ol>
                                ...
                                <li>(Phone) Choice 3: "A key item." (+2)</li>
                            </ol>
                        </li>
                        <li>Hermit Rank 9 Romance
                            <ol>
                                <li>Choice 1: "You've really matured." (+3)</li>
                                <li>Choice 2: "Are you okay, Futaba?" (+3)</li>
                                <li>Choice 2: "No way." (+2)</li>
                                ...
                                <li>-</li>
                                <li>-</li>
                                <li>(Phone) Choice 3: "Do I really have to say it?" (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        ...
                        <li>Hanged Rank 10 <strong>(Proficiency +3)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Mon 11/14</h3>
                    <h4>Train</h4>
                    <ul>
                        <li>Finish reading "Social Thought" <strong>(Knowledge +5)</strong></li>
                    </ul>
                    <h4>Class</h4>
                    <ul>
                    ...
                    <ul>
                        ...
                        <li>Empress Rank 7
                            <ol>
                                ...
                                <li>(Phone) Choice 2: "I'll always have your back." (+3)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                ...
                <div className="day">
                    ...
                    <ul>
                        <li>Empress Rank 8
                            <ol>
                                ...
                                <li>(Phone) Choice 3: "I want some too." (+3)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li><strong>[Normal Route]</strong> Free Time</li>
                        <li><strong>[Battle Route]</strong> Devil Rank 10</li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Wed 11/16</h3>
                    ...
                    <ul>
                        ...
                        <li>Jazz club with Justice <strong>(SP +20)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Thu 11/17</h3>
                    <h4>Train</h4>
                    <ul>
                        <li>Finish reading "Factorization Guide" <strong>(Extra note when studying)</strong></li>
                    </ul>
                    <h4>Class</h4>
                    <ul>
                    ...
                    <ul>
                        <li>Crane game
                            <ol>
                                <li>Receive Lexy Doll</li>
                            </ol>
                        </li>
                        <li>Buy "Medjed Menace", "Wise Men's Words", and "Tidying the Heart" from Shibuya bookstore</li>
                ...
                <div className="day">
                    ...
                    <ul>
                        <li>Cannot leave Leblanc</li>
                        <li>TV Quiz: "Speaker of the House decides." <strong>(Knowledge +2)</strong></li>
                        <li>Free Time</li>
                    </ul>
                </div>
                <div className="day">
                ...
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Fishing <strong>(Proficiency +2)</strong></li>
                ...
                <div>
                    <Link to="../december">Go to December</Link>
                </div>
            </main>
        </Layout>
    );
