            ...
            <main>
                ...
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Interact with the crossword on innermost booth of Leblanc, Complete blue squares:
                            "Semesters" <strong>(Knowledge +2)</strong></li>
                ...
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Talk to Ryuji outside 2D classroom, Chariot Rank 2 <strong>(Do not need matching arcana,
                            expect 1 less note)</strong>
                            <ol>
                                <li>Choice 1: "I'm counting on you." (+3)</li>
                                <li>-</li>
                                <li>Choice 1: "Do you go want to go back?" (+2)</li>
                                <li>(Phone) Choice 3: "It's never too late, man." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        ...
                        <li>Talk to Leblanc customers repeatedly to get them to leave, Interact with books on
                            countertop, Read "Pirate Legend"
                        </li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li><strong>Need at least Y30,000</strong></li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Cannot leave Leblanc</li>
                    ...
                    <ul>
                        <li>Chariot Rank 3
                            <ol>
                                ...
                                <li>(Phone) Choice 1: "I can't exactly blame you." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                ...
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Drink Aojiru <strong>(Y5000)</strong> at Shibuya underground platform <strong>(Charm
                            +2)</strong></li>
                        <li>Watch movies in Shibuya <strong>(Guts +5)</strong> <strong>(Guts Lv. 2)</strong></li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Visit bathhouse outside Leblanc <strong>(Charm +5)</strong> <strong>(Charm Lv. 2)</strong>
                        </li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <h4>Class</h4>
                    <ul>
                        <li>Question with matching arcana: "You unquestioningly support it." and "You have a duty to
                            correct it." <strong>(Charm +2)</strong> <strong>(Lovers +2)</strong></li>
                    </ul>
                    <h4>Daytime</h4>
                    <ul>
                        <li>Borrow "The Alluring Dancer" from library</li>
                        <li>Death Rank 2 <strong>(Requires Guts Lv. 2)</strong> <strong>(Guts +2)</strong>
                            <ol>
                                <li>Choice 1: "I have a bad heart." (+2)</li>
                                <li>Choice 1: "I agree." (+2)</li>
                                <li>(Phone) Choice 1: "I'm totally fine." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Hierophant Rank 2 <strong>(Kindness +3)</strong>
                            <ol>
                                <li>Choice 1: "Making coffee." (+2)</li>
                                <li>Choice 2: "That guy seemed suspicious." (+2)</li>
                                <li>Choice 1: "I want the ladies to love me." (+2)</li>
                                <li>(Phone) Choice 1: "Got it." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                </div>
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Interact with study booths in Shujin library, Study at library <strong>(Knowledge +2, Guts
                            +2)</strong></li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Interact with coffee tools on Leblanc countertop, Brew coffee with matching arcana <strong>(Charm
                ...
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Chariot Rank 4 <strong>(Ogikubo unlocked)</strong>
                            <ol>
                ...
                <div className="day">
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Death Rank 3 <strong>(Guts +2)</strong>
                            <ol>
                                <li>-</li>
                                <li>-</li>
                                <li>Choice 1: "I don't mind." (+2)</li>
                                <li>(Phone) Choice 1: "Of course not." (+2)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                ...
                <div className="day">
                    ...
                    <h4>Train</h4>
                    <ul>
                        <li>Read "The Alluring Dancer"</li>
                    </ul>
                    <h4>Class</h4>
                    <ul>
                    ...
                    <h4>Daytime</h4>
                    <ul>
                        <li>Sign up for Triple Seven convenience store job from part-time listings in Shibuya
                            underground walkway
                        </li>
