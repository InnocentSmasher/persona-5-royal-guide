        ...
        <Layout>
            ...
            <main>
                ...
                <div className="day">
                    ...
                    <h4>Class</h4>
                    <ul>
                        <li>Question with matching arcana: "How numerous they are." and "The Eight Million
                            Gods." <strong>(Charm +2)</strong> <strong>(Lovers +2)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Thu 1/12</h3>
                    ...
                    <ul>
                        ...
                        <li>Faith Rank 6
                            <ol>
                                ...
                                <li>-</li>
                                <li>-</li>
                                <li>(Phone) Choice 2: "You have to face it." (+3)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                    ...
                    <ul>
                        <li>Faith Rank 7
                            <ol>
                                ...
                                <li>(Phone) Choice 3: "I love a good challenge." (+3)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                ...
                <div className="day">
                    ...
                    <h4>Evening</h4>
                    <ul>
                        <li>Jazz club with Emperor <strong>(Learns Ali Dance)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Mon 1/16</h3>
                    ...
                    <ul>
                        <li>Faith Rank 9 Friendship
                            <ol>
                                ...
                                <li>(Phone) Choice 1: "I'm glad to hear that." (+3)</li>
                            </ol>
                        </li>
                        <li>Faith Rank 9 Romance
                            <ol>
                                <li>-</li>
                                <li>Choice 1: "It's no problem." (+3)</li>
                                <li>Choice 1: "Definitely." (+3)</li>
                                ...
                                <li>(Phone) Choice 1: "Get used to it." (+3)</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                ...
                <div className="day">
                    ...
                    <h4>Train</h4>
                    <ul>
                        <li>Finish reading "Essence of Fishing" <strong>(Unlocks Third Eye for fishing)</strong></li>
                    </ul>
                    <h4>Daytime</h4>
                    <ul>
                        <li>Faith Rank 10</li>
                ...
                <div className="day">
                    ...
                    <ul>
                        <li>Rain</li>
                        <li>Darts with Faith <strong>(Proficiency +3)</strong>
                            <ol>
                                <li>Let your partner finish on round 4 <strong>(Baton Pass Lv. 3)</strong></li>
                                <li>Choice 3: "Trust your instincts." <strong>(Faith +1)</strong></li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                ...
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Jazz club with Chariot <strong>(Learns Arms Master)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Mon 1/23</h3>
                ...
                <div className="day">
                    ...
                    <h4>Class</h4>
                    <ul>
                        <li>Question: "Kind-hearted.", "Negative.", and "Resentful." <strong>(Knowledge +2)</strong>
                        </li>
                    </ul>
                    <h4>Daytime</h4>
                    <ul>
                ...
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li><strong>Reach final floor of Mementos Palace</strong>
                            <ol>
                                <li>A Small Cry for Help</li>
                                <li>O My Young Sister, I Cry For You</li>
                            </ol>
                        </li>
                    </ul>
                    <h4>Evening</h4>
                ...
                <div className="day">
                    ...
                    <h4>Train</h4>
                    <ul>
                        <li>Finish reading "Batting Science" <strong>(Unlocks Third Eye for batting cage)</strong></li>
                    </ul>
                    <h4>Daytime</h4>
                    <ul>
                ...
                <div className="day">
                    ...
                    <h4>Evening</h4>
                    <ul>
                        <li>Jazz club with Lovers <strong>(Learns Spell Master)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Mon 1/30</h3>
                ...
                <div>
                    <Link to="../february">Go to February</Link>
                </div>
            </main>
        </Layout>
    );
