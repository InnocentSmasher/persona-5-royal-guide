            ...
            <main>
                ...
                <div className="day">
                    ...
                    <ul>
                        ...
                        <li>Batting center <strong>(Proficiency +3)</strong></li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Trade Angel Tart for Feverent Bat</li>
                        <li>Jazz club with Magician <strong>(Learns Debilitate)</strong></li>
                    </ul>
                </div>
                <div className="day">
                    <h3>Mon 12/12</h3>
                ...
                <div className="day">
                    ...
                    <ul>
                        <li>Crane game
                            <ol>
                                <li>Receive Black Frost Doll</li>
                            </ol>
                        </li>
                        <li>Free Time</li>
                        <li>Buy "Essence of Fishing" and "Batting Science" from Shinjuku bookstore</li>
                    </ul>
                    <h4>Evening</h4>
                    <ul>
                        <li>Free Time</li>
                ...
                <div className="day">
                    ...
                    <h4>All Day</h4>
                    <ul>
                        <li>Exams: "D.", "Over one billion yen.", "Having his head displayed.", and "Public
                            performance."
                        </li>
                    </ul>
                </div>
                ...
                <div className="day">
                    ...
                    <ul>
                        <li>Cannot leave Leblanc</li>
                        <li>Talk to Sojiro for exam reward - Boss Undies - Endure</li>
                        <li>Free Time</li>
                    </ul>
                </div>
                <div className="day">
                ...
                <div>
                    <Link to="../january">Go to January</Link>
                </div>
            </main>
        </Layout>
    );
